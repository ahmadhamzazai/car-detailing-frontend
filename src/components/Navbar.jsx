        ...
        <nav className="flex items-center justify-between py-4 px-4 text-white">
          ...
          <div className="w-1/2 items-center justify-center sm:text-base">
            <ul className="flex items-center justify-center gap-[3rem] list-none ">
              ...
              <li className="cursor-pointer hover:text-yellow-400">Gallery</li>
              <li className="cursor-pointer hover:text-yellow-400">Reviews</li>
              <li className="cursor-pointer hover:text-yellow-400">Contact</li>
            </ul>
          </div>

          <div className="flex justify-center items-center gap-3">
            <button className="bg-yellow-400 whitespace-nowrap text-white rounded-full hover:bg-gray-800 border border-transparent hover:border-yellow-600">
              Book Now
            </button>
            <div className="menu">
              <HiOutlineMenu />
