...
const Section2 = () => {
  return (
    <section className="max-w-screen-2xl mx-auto  px-4 mt-9 section2 flex flex-col items-center gap-9">
      ...
      <div className="services-cards max-w-[1300px] mx-auto flex flex-wrap justify-center gap-4">
        {services_data?.map((card, index) => {
          return (
            <div className="service-card rounded-lg shadow-xl p-5 flex flex-col items-center justify-center gap-3">
